...
{
    public class WaterPatternOptions
    {
        public WaterPatternOptions(){}
        public WaterPatternOptions(int cityId,int karbari,int tariff,int categoryUses,int tedadVahed,bool isVillage,int readCode){
            CityId = cityId;
            Karbari = karbari;
            Tariff = tariff;
